function GlobalBest = PSO_planner(image_file,pStart,pGoal)
plot_env = true;
env=CreateEnv(image_file,pStart,pGoal,plot_env);                     %% setup the environment
...
ylabel('Minimal Cost');
grid on;
% exportgraphics(f,['sims/cost-' date '.png'],'Resolution',300);