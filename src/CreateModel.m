function model=CreateModel()
    ...
    model.nWaypoints=300;   % number of waypoints in the path, n in the paper
    model.beta=100;         % penalty parameter for obstacle collision, c_v in the paper
    model.MaxIt=10;        % Maximum Number of Iterations G=50 in the paper
    model.nParticle=60;    % number of particles for each iteration P=300 in the paper
    ...
    model.c1=chi*model.phi1/chi;         % Personal Learning Coefficient
    model.c2=chi*model.phi2/chi;         % Global Learning Coefficient
