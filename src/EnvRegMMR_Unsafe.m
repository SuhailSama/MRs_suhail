function [unsafeRegion,centersMMRs, radiiMMRs]= EnvRegMMR_Unsafe(image_file_name, IsPlot)
...
%     imshowpair(maskedRGBImage,img_resized, "montage")
    subplot(1,2,1)
%     imshowpair(img_resized,unsafeRegion, "montage")
    imshow(img_resized)
